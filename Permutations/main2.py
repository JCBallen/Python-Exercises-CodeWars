...
def permutations(s):
    ...
    for i in range(10**len(s)):
        ...
        for comb in perm_with_nums:  # Hacemos la traduccion de numeros a letras
            translation.append([dict_nums_to_letters[int(x)] for x in comb])
